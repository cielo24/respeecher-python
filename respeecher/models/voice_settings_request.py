...
class VoiceSettingsRequest(BaseModel):
    ...
    narration_style_id: Optional[StrictStr] = None
    accent_id: Optional[StrictStr] = None
    semitones_correction: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["voice_id", "narration_style_id", "accent_id", "semitones_correction"]
