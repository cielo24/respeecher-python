...
class AccountStatisticsTimeConvertedPreviousMonthesInner(BaseModel):
    """
    AccountStatisticsTimeConvertedPreviousMonthesInner
    """ # noqa: E501
    month: Optional[date] = None
    duration: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["month", "duration"]
