...
class UpdateRecordingRequest(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="New label for the recording")
    starred: Optional[StrictBool] = Field(default=None, description="Mark the recording as starred or not")
    __properties: ClassVar[List[str]] = ["label", "starred"]
