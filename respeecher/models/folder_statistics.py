...
class FolderStatistics(BaseModel):
    ...
    FolderStatistics
    """ # noqa: E501
    folder_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the folder.")
    stats: Optional[FolderStatisticsStats] = None
    __properties: ClassVar[List[str]] = ["folder_id", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": FolderStatisticsStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
